...
class MTLClassifier:
    ...
    def run_manual_tuning(self):
        ...
        train_utils.run_manual_tuning(self.config, self.device)
    ...
    def run_optuna_study(
        ...
        train_utils.run_optuna_study(self.config, self.device)
    ...
    def load_and_evaluate_test_model(
        ...
        eval_utils.load_and_evaluate_test_model(self.config, device=self.device)
