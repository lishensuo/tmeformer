...
def sum_ensembl_ids(
    ...
    if file_format == "loom":
        ...
        with lp.connect(data_directory) as data:
            ...
            #  gene_mapping_dict： key不冗余， value冗余
            ## 取在gene_mapping_dict的key中所有的ensemble id
        ...
        # must be counts layer
        assert "counts" in data.layers.keys(), "counts layer missing from data"
